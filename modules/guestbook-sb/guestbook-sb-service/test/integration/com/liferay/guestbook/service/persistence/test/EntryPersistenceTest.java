...
package com.liferay.guestbook.service.persistence.test;

import com.liferay.arquillian.extension.junit.bridge.junit.Arquillian;

import com.liferay.guestbook.exception.NoSuchEntryException;
import com.liferay.guestbook.model.Entry;
import com.liferay.guestbook.service.EntryLocalServiceUtil;
import com.liferay.guestbook.service.persistence.EntryPersistence;
import com.liferay.guestbook.service.persistence.EntryUtil;
...
public class EntryPersistenceTest {
	...
	protected OrderByComparator<Entry> getOrderByComparator() {
		return OrderByComparatorFactoryUtil.create("GB_Entry", "uuid", true,
			"entryId", true, "groupId", true, "companyId", true, "userId",
			true, "userName", true, "createDate", true, "modifiedDate", true,
			"status", true, "statusByUserId", true, "statusByUserName", true,
			"statusDate", true, "name", true, "email", true, "message", true,
			"guestbookId", true);
	}
	...
	public void testResetOriginalValues() throws Exception {
		...
		Assert.assertTrue(Objects.equals(existingEntry.getUuid(),
