...
import com.liferay.guestbook.model.EntryModel;
import com.liferay.guestbook.model.EntrySoap;
...
public class EntryModelImpl extends BaseModelImpl<Entry> implements EntryModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.guestbook.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.guestbook.model.Entry"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.guestbook.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.guestbook.model.Entry"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.guestbook.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.guestbook.model.Entry"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.guestbook.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.guestbook.model.Entry"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.guestbook.model.Entry");
